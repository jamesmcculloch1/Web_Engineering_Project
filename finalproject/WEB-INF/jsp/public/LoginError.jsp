...
Description: LoginError.jsp displayed when an error occurs notifying user that the input was invalid.
--%>
					...
					<div class="content-div">
						<div class="login-container">
							...
							<form class="login" name="j_username" action="j_security_check" method="POST">
								...
								<br />
								<input type="text" class="textIn" id="username" placeholder="username..." name="j_username">
								<%--ENTER USERNAME--%>
								<br/>
								<%--ENTER PASSWORD--%>
